...
class SignupActivity :AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.signup_acitivity);
...
//
                ...
                val city:String=location.text.toString();
                val user=USER(username.text.toString(),downloadurl,downloadurl,mAuth.uid!!, number = s1!!,city=city)
        ...
        if (resultCode == Activity.RESULT_OK && requestCode == 1000) {
            ...
            if (data != null) {
                data.data.let {
                    ...
                    try {
                        slectimage.visibility= View.GONE
                        uploadimage(it)
